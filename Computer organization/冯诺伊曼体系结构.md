...
SoC：an [integrated circuit](https://en.wikipedia.org/wiki/Integrated_circuit) that integrates all or most components of a computer or other [electronic system](https://en.wikipedia.org/wiki/Electronics). 树莓派，ARM开发板都可以认为是SoC，

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MjkwMTMyMzcsLTE4NjI4MDQxMywtNz
